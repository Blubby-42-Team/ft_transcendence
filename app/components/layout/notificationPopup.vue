...
<template>
	<div class="absolute top-0 right-0 z-10 pt-[4.5rem] h-max w-96 overflow-hidden">
		<template v-for="noti in notif.slice(-3)">
			<div class="h-24 px-2 pb-2 w-96">
				<div class="grid w-full h-full grid-cols-[auto,2rem] grid-rows-[2rem,auto] bg-background1 hover:bg-opacity-50 p-2 rounded-xl"
